...
-   **R-INLA package**: Model fitting and inference is fully Bayesian using the well-known INLA technique through the `R-INLA` package.
    ...
    ***IMPORTANT NOTES**:*
    ...
    -   Visit the [R-INLA website](https://www.r-inla.org/download-install) for further details about how to install the package on MacOS and for information on version compatibilities.
